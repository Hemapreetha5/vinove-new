 ...
 Awesomizr.createTableOfContents = function(params) {
     ...
     var lineTag = params.line.tag || 'div';
     var lineClass = params.line.addClass || '';
 
     var containerTag = params.container.tag || 'div';
     var containerClass = params.container.addClass || '';
    ...
    //  var tocTitle = params.toctitle || tocDefaultParams.toctitle;
     ...
     for (var i = 0; i < elements.length; i++) {
         ...
         toc += '<'+lineTag+' class="'+lineClass+' ro-toc-level-' + tocLevel + '"><a href="#' + id + '">'
             + text + '</a></'+lineTag+'>';
     }
     
     // Prepare to wrap TOC HTML into container
     var tocContainer = '<'+containerTag+' class="'+containerClass+' ' + tocClass + '">';
